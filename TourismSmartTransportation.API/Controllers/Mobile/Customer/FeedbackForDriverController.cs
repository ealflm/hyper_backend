...
namespace TourismSmartTransportation.API.Controllers.Mobile.Customer
{
    ...
    [Route(ApiVer1Url.Customer.FeebackForDriver)]
    public class FeedbackForDriverController : BaseController
    {
        private readonly IFeedbackForDriverService _service;

        public FeedbackForDriverController(IFeedbackForDriverService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> CreateCustomertrip([FromBody] FeedbackForDriverSearchModel model)
        {
